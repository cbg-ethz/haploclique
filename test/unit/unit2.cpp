...
TEST(edgeBetweenFunctionTest, edgeBetweenSameAlignments){
    ...
    alignment.restoreAlignmentRecord("test/data/simulation/unit_data/alignment_sample00.txt");
...
TEST(edgeBetweenFunctionTest, edgeBetweenNonOverlappingAlignments){
    ...
    EdgeCalculator* edge_calculator = nullptr;
    try{
        alignment1.restoreAlignmentRecord("test/data/simulation/unit_data/alignment_sample01.txt");
    }catch (...){
        cout << "File not found!" << endl;
    }
    
    try{
        alignment2.restoreAlignmentRecord("test/data/simulation/unit_data/alignment_sample02.txt");
    }catch (...){
...
TEST(edgeBetweenFunctionTest, edgeBetweenOverlappingCrossPairsAlignments){
    ...
    try{
        alignment2.restoreAlignmentRecord("test/data/simulation/unit_data/alignment_sample03.txt");
    }catch (...){
        cout << "File 2 not found!" << endl;
    }
...
// This test verifies if the algorithm considers an edge between two AlignmentRecords with incompatible gap (deletion).
TEST(edgeBetweenFunctionTest, edgeBetweenIncompatibleDelAlignments){
    ...
    try{
        alignment2.restoreAlignmentRecord("test/data/simulation/unit_data/alignment_sample05.txt");
    }catch (...){
        cout << "File 2 not found!" << endl;
    }
    double Q = 0.9;
...
// This test verifies if the algorithm considers an edge between two similar AlignmentRecords that satisfies the following condition:
//       ----  -----
//----   -----
TEST(edgeBetweenFunctionTest, edgeBetweenIncompatibleAlignments1){
    ...
    EdgeCalculator* edge_calculator = nullptr;
    try{
        alignment1.restoreAlignmentRecord("test/data/simulation/unit_data/alignment_sample06.txt");
    }catch (...){
        cout << "File not found!" << endl;
    }
    
    try{
        alignment2.restoreAlignmentRecord("test/data/simulation/unit_data/alignment_sample00.txt");
    }catch (...){
        cout << "File 2 not found!" << endl;
    }
    double Q = 0.9;
...
TEST(edgeBetweenFunctionTest, edgeBetweenIncompatibleAlignments2){
    ...
    try{
        alignment2.restoreAlignmentRecord("test/data/simulation/unit_data/alignment_sample07.txt");
    }catch (...){
        cout << "File 2 not found!" << endl;
    }
    double Q = 0.9;
...
TEST(edgeBetweenFunctionTest, edgeBetweenIncompatibleGapSimilarAlignments){
    ...
    try{
        alignment2.restoreAlignmentRecord("test/data/simulation/unit_data/alignment_sample08.txt");
    }catch (...){
        cout << "File 2 not found!" << endl;
    }
    double Q = 0.9;
...
//----          -----
//----  -----
TEST(edgeBetweenFunctionTest, edgeBetweenIncompatibleAlignments3){
    
    AlignmentRecord alignment1;
    AlignmentRecord alignment2;
    EdgeCalculator* edge_calculator = nullptr;
    try{
        alignment1.restoreAlignmentRecord("test/data/simulation/unit_data/alignment_sample07.txt");
    }catch (...){
        cout << "File not found!" << endl;
    }
...
//      ----  -----
//----        -----
TEST(edgeBetweenFunctionTest, edgeBetweenIncompatibleAlignments4){
...
TEST(edgeBetweenFunctionTest, edgeBetweenIncompatibleAlignments5){
    ...
    try{
        alignment2.restoreAlignmentRecord("test/data/simulation/unit_data/alignment_sample06.txt");
    }catch (...){
        cout << "File 2 not found!" << endl;
    }
    double Q = 0.9;
